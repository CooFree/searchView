...
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:self action:@selector(cancelDidClick)];
    ...
    _navgationView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, self.view.py_width, 64)];
    _navgationView.backgroundColor=[UIColor whiteColor];
    [self.view addSubview:_navgationView];
    
    UIButton *backBtn=[UIButton buttonWithType:UIButtonTypeCustom];
    backBtn.frame=CGRectMake(10, 20, 40, 44);
    ...
    UISearchBar *searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(CGRectGetMaxX(backBtn.frame), 20, self.view.py_width-50-CGRectGetMaxX(backBtn.frame), 44)];
